...
extern SDL_Texture* player_dive_end_texture;
extern SDL_Texture* player_dive_smoke_texture;
...
extern SDL_Texture* player2_dive_end_texture;
extern SDL_Texture* player2_dive_smoke_texture;
